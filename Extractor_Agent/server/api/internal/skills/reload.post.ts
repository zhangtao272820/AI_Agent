import { clearPlaybookCache } from '../../../utils/playbook_skills'
...
/** POST /api/internal/skills/reload — 平台赋能后通知（清 playbook 缓存） */
export default defineEventHandler((event) => {
  ...
  clearPlaybookCache()
  return { ok: true, message: 'extractor skill reload acknowledged' }
})
