...
type EvolvedStore = { hints: RagEvolvedHint[] };

const STAGE_SCOPE: Record<RagEvolvedHint["stage"], string> = {
  retrieval: "检索路由与召回",
  expansion: "Multi-Query 扩展",
  generate: "答案生成",
};
...
function evolvedFile() {
  ...
  return join(dir, "rag-evolved-hints.json");
}
...
export function listEvolvedHints(stage?: RagEvolvedHint["stage"]) {
